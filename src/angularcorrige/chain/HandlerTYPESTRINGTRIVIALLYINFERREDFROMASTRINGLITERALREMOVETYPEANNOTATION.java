...
public class HandlerTYPESTRINGTRIVIALLYINFERREDFROMASTRINGLITERALREMOVETYPEANNOTATION extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Type string trivially inferred from a string literal, remove type annotation".equals(acao);
    }
