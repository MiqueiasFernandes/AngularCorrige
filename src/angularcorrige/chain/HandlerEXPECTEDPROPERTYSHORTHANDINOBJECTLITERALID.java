...
public class HandlerEXPECTEDPROPERTYSHORTHANDINOBJECTLITERALID extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Expected property shorthand in object literal ('{id}').".equals(acao);
    }
