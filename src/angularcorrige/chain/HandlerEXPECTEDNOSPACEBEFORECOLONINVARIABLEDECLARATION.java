...
public class HandlerEXPECTEDNOSPACEBEFORECOLONINVARIABLEDECLARATION extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " expected nospace before colon in variable-declaration".equals(acao);
    }
