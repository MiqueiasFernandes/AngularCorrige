...
public class HandlerPARENTHESESAREREQUIREDAROUNDTHEPARAMETERSOFANARROWFUNCTIONDEFINITION extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Parentheses are required around the parameters of an arrow function definition".equals(acao);
    }
