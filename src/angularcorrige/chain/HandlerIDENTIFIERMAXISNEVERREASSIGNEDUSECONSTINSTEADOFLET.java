...
public class HandlerIDENTIFIERMAXISNEVERREASSIGNEDUSECONSTINSTEADOFLET extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Identifier 'max' is never reassigned; use 'const' instead of 'let'.".equals(acao);
    }
