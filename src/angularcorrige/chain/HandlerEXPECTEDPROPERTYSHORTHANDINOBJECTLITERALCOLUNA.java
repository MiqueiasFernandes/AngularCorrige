...
public class HandlerEXPECTEDPROPERTYSHORTHANDINOBJECTLITERALCOLUNA extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Expected property shorthand in object literal ('{coluna}').".equals(acao);
    }
