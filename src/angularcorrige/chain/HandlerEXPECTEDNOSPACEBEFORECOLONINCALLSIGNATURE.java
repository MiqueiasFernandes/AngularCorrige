...
public class HandlerEXPECTEDNOSPACEBEFORECOLONINCALLSIGNATURE extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " expected nospace before colon in call-signature".equals(acao);
    }
