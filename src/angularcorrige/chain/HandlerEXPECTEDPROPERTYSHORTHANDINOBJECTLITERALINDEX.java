...
public class HandlerEXPECTEDPROPERTYSHORTHANDINOBJECTLITERALINDEX extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Expected property shorthand in object literal ('{index}').".equals(acao);
    }
