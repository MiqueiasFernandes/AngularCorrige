...
public class HandlerEXPECTEDNOSPACEBEFORECOLONINPROPERTYDECLARATION extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " expected nospace before colon in property-declaration".equals(acao);
    }
