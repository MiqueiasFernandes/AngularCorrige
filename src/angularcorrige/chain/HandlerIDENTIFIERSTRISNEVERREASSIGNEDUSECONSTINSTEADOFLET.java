...
public class HandlerIDENTIFIERSTRISNEVERREASSIGNEDUSECONSTINSTEADOFLET extends AbstractHandler {

    @Override
    boolean accept(String acao) {
        return " Identifier 'str' is never reassigned; use 'const' instead of 'let'.".equals(acao);
    }
